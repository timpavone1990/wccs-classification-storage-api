...
class PageStatementBuilder {
    ...
    pageReferencesRelationships(page, pageAlias) {
        ...
        referenceNames.forEach((referenceName, index) => {
            ...
            statements.push(`MERGE (${pageAlias})-[:Reference {name: $${referenceAlias}.name, type: $${referenceAlias}.type}]->(${referencedPageAlias})`);
