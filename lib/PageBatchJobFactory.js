...
class PageStatementBuilder {
    ...
    properties(parent) {
        ...
        propertyNames.forEach(propertyName => {
            return this.property(parent.properties[propertyName], propertyName);
        });
    }
    ...
    property(property, name) {
        if (Array.isArray(property)) {
            ...
            this.relationshipsToProperties(property);
            this.relationshipsToReferencedResources(property);
            this.relationshipsToContent(property);
        }
    }
    ...
    relationshipsToProperties(object) {
