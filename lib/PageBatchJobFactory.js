...
class PageStatementBuilder {
    ...
    referenceRelationShip(referenceAlias) {
        return `:Reference {` +
                    `name: $${referenceAlias}.name,` +
                    `type: $${referenceAlias}.type,` +
                    `selectorType: $${referenceAlias}.selector.type,` +
                    `startSelectorType: $${referenceAlias}.selector.startSelector.type,` +
                    `startSelectorValue: $${referenceAlias}.selector.startSelector.value,` +
                    `startSelectorOffset: $${referenceAlias}.selector.startSelector.offset,` +
                    `endSelectorType: $${referenceAlias}.selector.endSelector.type,` +
                    `endSelectorValue: $${referenceAlias}.selector.endSelector.value,` +
                    `endSelectorOffset: $${referenceAlias}.selector.endSelector.offset` +
            `}`;
    }
