...
describe("#GetPageHelper", () => {
    it("should return statements", () => {
        ...
        expect(statements).to.eql({
            "statements": [
                {
                    "statement": "MATCH (page:Resource {url: $url}) RETURN page {.type, .url}",
                    ...
                    "statement":
                        ...
                        "WITH collect({" +
                            ...
                            "selector: {" +
                                ...
                                "endSelector: {type: pagePropertyRelationship.endSelectorType, value: pagePropertyRelationship.endSelectorValue, offset: pagePropertyRelationship.endSelectorOffset}" +
                            "}" +
