...
module.exports = class GetPageHelper {
    ...
    getPageStatement(url) {
        ...
        const getSubProperties =
            ...
            "RETURN {property: property.checksum, subProperties: collect({name:subPropertyRelationship.name, checksum: subProperty.checksum})}  AS result ORDER BY result.property";
