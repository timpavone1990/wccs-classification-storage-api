            ...
            "statements": [{
                "statement":
                    (
                        ...
                        "MERGE (p_prop0:Content {checksum: $p_prop0.checksum,type: $p_prop0.type,content: $p_prop0.content})\n" +
                        "\n" +
                        ...
                        "MERGE (p_prop1_prop0:Content {checksum: $p_prop1_prop0.checksum,type: $p_prop1_prop0.type,content: $p_prop1_prop0.content})\n" +
                        "\n" +
                        "\n" +
                        "MERGE (p_prop1_prop1:Content {checksum: $p_prop1_prop1.checksum,type: $p_prop1_prop1.type,content: $p_prop1_prop1.content})\n" +
                        "\n" +
                        "\n" +
                        "MERGE (p_prop1_ref0_p:Page {url: $p_prop1_ref0.destination})\n" +
                        "MERGE (p_prop1_ref1_p:Page {url: $p_prop1_ref1.destination})\n" +
                        "MERGE (p_prop1:Content {checksum: $p_prop1.checksum,type: $p_prop1.type,content: $p_prop1.content})\n" +

                        "MERGE (p_prop1)-[:Property {" +
                        ...
                        "MERGE (p_prop2_item0:Content {checksum: $p_prop2_item0.checksum,type: $p_prop2_item0.type,content: $p_prop2_item0.content})\n" +
                        "\n" +
                        "\n" +
                        "MERGE (p_prop2_item1:Content {checksum: $p_prop2_item1.checksum,type: $p_prop2_item1.type,content: $p_prop2_item1.content})\n" +
                        "\n" +
                        "\n" +
                        ...
                        "WITH p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1,p_prop2_item0,p_prop2_item1,p_ref0_p,p_ref1_p,p_ref2_p,p\n" +
                        "OPTIONAL MATCH (p)-[e]->()\n" +
                        "DELETE e\n" +
