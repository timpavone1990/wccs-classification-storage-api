        ...
        expect(statements).to.eql({
            "statements": [{
                "statement":
                    ...
                    "MERGE (p_0)-[:Reference {name: $p_0_ref0.name, type: $p_0_ref0.type}]->(p_0_ref0_p)\n" +
                    "MERGE (p_0_ref1_p:Page {url: $p_0_ref1.destination})\n" +
                    "MERGE (p_0)-[:Reference {name: $p_0_ref1.name, type: $p_0_ref1.type}]->(p_0_ref1_p)\n" +
                    "MERGE (p_1_0:Content {type: $p_1_0.type})\n" +
                    "MERGE (p_1_1:Content {type: $p_1_1.type})\n" +
                    "MERGE (p_1:Content {type: $p_1.type})-[:Property {name: $p_1_0.name}]->(p_1_0)-[:Parent]->(p_1)-[:Property {name: $p_1_1.name}]->(p_1_1)-[:Parent]->(p_1)\n" +
                    "MERGE (p_1_ref0_p:Page {url: $p_1_ref0.destination})\n" +
                    "MERGE (p_1)-[:Reference {name: $p_1_ref0.name, type: $p_1_ref0.type}]->(p_1_ref0_p)\n" +
                    "MERGE (p_1_ref1_p:Page {url: $p_1_ref1.destination})\n" +
                    "MERGE (p_1)-[:Reference {name: $p_1_ref1.name, type: $p_1_ref1.type}]->(p_1_ref1_p)\n" +
