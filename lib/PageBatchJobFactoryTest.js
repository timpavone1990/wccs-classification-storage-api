    ...
    it("should compute the statements correctly", () => {
        ...
        expect(statements).to.eql({
            "statements": [
                ...
                {
                    // DELETE PAGE OUTGOING RELATIONSHIPS
                    "statement":
                    "MATCH (p:Resource {url: $p.url})-[e]->()\n" +
                    "DELETE e",
                    "parameters": { "p": {"url": "http://myhost/myfolder/mypage"} }
                },
                {
                    // PAGE OWNS
                    "statement":
                ...
                {
                    // SITE
                    "statement": "MERGE (s:Site {id: $s.id})",
                    "parameters": { "s": {"id": "MySite"} }
                },
                {
                    // CLEAN UP
                    "statement":
