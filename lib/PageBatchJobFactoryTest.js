        ...
        expect(statements).to.eql({
            "statements": [{
                "statement":
                    ...
                    "WITH p,p_prop0\n" +
                    "OPTIONAL MATCH (p_prop0)-[:Property]->(p_prop0_del:Content)\n" +
                    "DETACH DELETE p_prop0_del\n" +

                    "MERGE (p_prop1_prop0:Content {type: $p_prop1_prop0.type})\n" +
                    "WITH p,p_prop1_prop0\n" +
                    "OPTIONAL MATCH (p_prop1_prop0)-[:Property]->(p_prop1_prop0_del:Content)\n" +
                    "DETACH DELETE p_prop1_prop0_del\n" +

                    "MERGE (p_prop1_prop1:Content {type: $p_prop1_prop1.type})\n" +
                    "WITH p,p_prop1_prop1\n" +
                    "OPTIONAL MATCH (p_prop1_prop1)-[:Property]->(p_prop1_prop1_del:Content)\n" +
                    "DETACH DELETE p_prop1_prop1_del\n" +
                    ...
                    "WITH p,p_prop1_prop0,p_prop1_prop1\n" +
                    "OPTIONAL MATCH (p_prop1)-[:Property]->(p_prop1_del:Content)\n" +
                    "WHERE NOT p_prop1_del IN [p_prop1_prop0,p_prop1_prop1]\n" +
                    "DETACH DELETE p_prop1_del\n" +

                    "MERGE (p_prop2_item0:Content {type: $p_prop2_item0.type,text: $p_prop2_item0.text})\n" +
                    "WITH p,p_prop2_item0\n" +
                    "OPTIONAL MATCH (p_prop2_item0)-[:Property]->(p_prop2_item0_del:Content)\n" +
                    "DETACH DELETE p_prop2_item0_del\n" +

                    "MERGE (p_prop2_item1:Content {type: $p_prop2_item1.type,text: $p_prop2_item1.text})\n" +
                    "WITH p,p_prop2_item1\n" +
                    "OPTIONAL MATCH (p_prop2_item1)-[:Property]->(p_prop2_item1_del:Content)\n" +
                    "DETACH DELETE p_prop2_item1_del\n" +
