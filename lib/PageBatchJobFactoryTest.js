        ...
        expect(statements).to.eql({
            "statements": [{
                "statement":
                    ...
                    "MERGE (p_0:Content {type: $p_0.type})-[:Reference {" +
                        "name: $p_0_ref0.name," +
                        "type: $p_0_ref0.type," +
                        "selectorType: $p_0_ref0.selector.type," +
                        "startSelectorType: $p_0_ref0.selector.startSelector.type," +
                        "startSelectorValue: $p_0_ref0.selector.startSelector.value," +
                        "startSelectorOffset: $p_0_ref0.selector.startSelector.offset," +
                        "endSelectorType: $p_0_ref0.selector.endSelector.type," +
                        "endSelectorValue: $p_0_ref0.selector.endSelector.value," +
                        "endSelectorOffset: $p_0_ref0.selector.endSelector.offset" +
                    "}]->(p_0_ref0_p)-[:ReferencedBy]->(p_0)-[:Reference {" +
                        "name: $p_0_ref1.name," +
                        "type: $p_0_ref1.type," +
                        "selectorType: $p_0_ref1.selector.type," +
                        "startSelectorType: $p_0_ref1.selector.startSelector.type," +
                        "startSelectorValue: $p_0_ref1.selector.startSelector.value," +
                        "startSelectorOffset: $p_0_ref1.selector.startSelector.offset," +
                        "endSelectorType: $p_0_ref1.selector.endSelector.type," +
                        "endSelectorValue: $p_0_ref1.selector.endSelector.value," +
                        "endSelectorOffset: $p_0_ref1.selector.endSelector.offset" +
                    "}]->(p_0_ref1_p)-[:ReferencedBy]->(p_0)\n" +
                    ...
                    "MERGE (p_1:Content {type: $p_1.type})" +
                        "-[:Property {name: $p_1_0.name}]->(p_1_0)-[:Parent]->(p_1)" +
                        "-[:Property {name: $p_1_1.name}]->(p_1_1)-[:Parent]->(p_1)" +
                        "-[:Reference {" +
                            "name: $p_1_ref0.name," +
                            "type: $p_1_ref0.type," +
                            "selectorType: $p_1_ref0.selector.type," +
                            "startSelectorType: $p_1_ref0.selector.startSelector.type," +
                            "startSelectorValue: $p_1_ref0.selector.startSelector.value," +
                            "startSelectorOffset: $p_1_ref0.selector.startSelector.offset," +
                            "endSelectorType: $p_1_ref0.selector.endSelector.type," +
                            "endSelectorValue: $p_1_ref0.selector.endSelector.value," +
                            "endSelectorOffset: $p_1_ref0.selector.endSelector.offset" +
                        "}]->(p_1_ref0_p)-[:ReferencedBy]->(p_1)" +
                        "-[:Reference {" +
                            "name: $p_1_ref1.name," +
                            "type: $p_1_ref1.type," +
                            "selectorType: $p_1_ref1.selector.type," +
                            "startSelectorType: $p_1_ref1.selector.startSelector.type," +
                            "startSelectorValue: $p_1_ref1.selector.startSelector.value," +
                            "startSelectorOffset: $p_1_ref1.selector.startSelector.offset," +
                            "endSelectorType: $p_1_ref1.selector.endSelector.type," +
                            "endSelectorValue: $p_1_ref1.selector.endSelector.value," +
                            "endSelectorOffset: $p_1_ref1.selector.endSelector.offset" +
                        "}]->(p_1_ref1_p)-[:ReferencedBy]->(p_1)\n" +
                ...
                "parameters": {
                    ...
                    "p_0_ref0": {"type": "MyReference1.1Type", "name": "my_reference_1.1", "destination": "http://myhost/myfolder/myotherpage1.1", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//table[11]/tr[11]/td[11]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//table[11]/tr[11]/td[111]", "offset": 120 }}},
                    "p_0_ref1": {"type": "MyReference1.2Type", "name": "my_reference_1.2", "destination": "http://myhost/myfolder/myotherpage1.2", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//table[12]/tr[12]/td[12]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//table[12]/tr[12]/td[122]", "offset": 120 }}},
                    "p_1_ref0": {"type": "MyReference2.1Type", "name": "my_reference_2.1", "destination": "http://myhost/myfolder/myotherpage2.1", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//table[21]/tr[21]/td[21]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//table[21]/tr[21]/td[211]", "offset": 120 }}},
                    "p_1_ref1": {"type": "MyReference2.2Type", "name": "my_reference_2.2", "destination": "http://myhost/myfolder/myotherpage2.2", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//table[22]/tr[22]/td[22]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//table[22]/tr[22]/td[222]", "offset": 120 }}},
