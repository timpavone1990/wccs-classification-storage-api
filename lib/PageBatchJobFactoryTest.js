...
describe("#createPageStorageJob", () => {
    it("should compute the statements correctly", () => {
        ...
        expect(statements).to.eql({
            "statements": [
                { "statement": "MERGE (n:Content { type: $type })", "parameters": { "type": "MyProperty1Type" }},
                { "statement": "MERGE (n:Content { type: $type })", "parameters": { "type": "MyProperty2.1Type" }},
                { "statement": "MERGE (n:Content { type: $type })", "parameters": { "type": "MyProperty2.2Type" }},
                { "statement": "MERGE (n:Content { type: $type })", "parameters": { "type": "MyProperty2Type" }},
            ]
        });
    });
});