    ...
    it("should compute the statements correctly", () => {
        ...
        expect(statements).to.eql({
            "statements": [{
                "statement":
                    (
                        ...
                        "MERGE (p_prop1_prop0)-[p_prop1_prop0_ref0:References {" +
                            ...
                            "content: $p_prop1_prop0_ref0.content," +
                ...
                "parameters": {
                    "s": {"name": "MySite"},
                    "p_prop0": {"checksum": "9d8d05f58e7f022a410c2befcf60e35f","type": "MyProperty1Type", "name": "my_property_1", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//p[1]/span[1]/span[1]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//p[1]/span[1]/span[11]", "offset": 120 }}},
                    ...
                    "p_prop1_prop0": {"checksum": "b87582362591c34c65b8e474a39fc31d","type": "MyProperty2.1Type", "name": "my_property_2.1", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//p[21]/span[2]/span[21]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//p[21]/span[2]/span[211]", "offset": 120 }}},
                    "p_prop1_prop0_c": {"value": "MyProperty2.1Content"},
                    "p_prop1_prop0_ref0": {"type": "MyReference1.2Type", "name": "my_reference_2.1.1", "destination": "http://myhost/myfolder/myotherpage1.2", "content": "MyReference1.2Content", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//table[12]/tr[12]/td[12]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//table[12]/tr[12]/td[122]", "offset": 120 }}},
                    ...
                    "p_prop1": {"checksum": "59639aae1acbced6d317bee3da550643","type": "MyProperty2Type", "name": "my_property_2", "selector": {"type": "RangeSelector","startSelector": { "type": "XPathSelector", "value": "//p[2]/span[2]/span[2]","offset": 0 },"endSelector": { "type": "XPathSelector", "value": "//p[2]/span[2]/span[22]", "offset": 120 }}},
