        ...
        expect(statements).to.eql({
            "statements": [{
                "statement":
                    ...
                    "MERGE (p_prop0:Content {type: $p_prop0.type,content: $p_prop0.content})-[p_prop0_ref0:Reference {" +
                    ...
                    "}]->(p_prop0_ref0_p)-[:ReferencedBy]->(p_prop0)-[p_prop0_ref1:Reference {" +
                    ...
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0\n" +
                    "OPTIONAL MATCH (p_prop0)-[p_prop0_toDeletedProperty:Property]->(p_prop0_deletedProperty:Content)-[p_prop0_fromDeletedProperty:Parent]->(p_prop0)\n" +
                    "WHERE NOT p_prop0_deletedProperty IN []\n" +
                    "DELETE p_prop0_toDeletedProperty, p_prop0_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0\n" +
                    "OPTIONAL MATCH (p_prop0)-[p_prop0_toDeletedResource:Reference]->(p_prop0_deletedResource:Page)-[p_prop0_fromDeletedResource:ReferencedBy]->(p_prop0)\n" +
                    "WHERE NOT p_prop0_deletedResource IN [p_prop0_ref0_p,p_prop0_ref1_p]\n" +
                    "DELETE p_prop0_toDeletedResource, p_prop0_fromDeletedResource\n" +


                    "MERGE (p_prop1_prop0:Content {type: $p_prop1_prop0.type,content: $p_prop1_prop0.content})\n" +
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0\n" +
                    "OPTIONAL MATCH (p_prop1_prop0)-[p_prop1_prop0_toDeletedProperty:Property]->(p_prop1_prop0_deletedProperty:Content)-[p_prop1_prop0_fromDeletedProperty:Parent]->(p_prop1_prop0)\n" +
                    "WHERE NOT p_prop1_prop0_deletedProperty IN []\n" +
                    "DELETE p_prop1_prop0_toDeletedProperty, p_prop1_prop0_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0\n" +
                    "OPTIONAL MATCH (p_prop1_prop0)-[p_prop1_prop0_toDeletedResource:Reference]->(p_prop1_prop0_deletedResource:Page)-[p_prop1_prop0_fromDeletedResource:ReferencedBy]->(p_prop1_prop0)\n" +
                    "WHERE NOT p_prop1_prop0_deletedResource IN []\n" +
                    "DELETE p_prop1_prop0_toDeletedResource, p_prop1_prop0_fromDeletedResource\n" +


                    "MERGE (p_prop1_prop1:Content {type: $p_prop1_prop1.type,content: $p_prop1_prop1.content})\n" +
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1\n" +
                    "OPTIONAL MATCH (p_prop1_prop1)-[p_prop1_prop1_toDeletedProperty:Property]->(p_prop1_prop1_deletedProperty:Content)-[p_prop1_prop1_fromDeletedProperty:Parent]->(p_prop1_prop1)\n" +
                    "WHERE NOT p_prop1_prop1_deletedProperty IN []\n" +
                    "DELETE p_prop1_prop1_toDeletedProperty, p_prop1_prop1_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1\n" +
                    "OPTIONAL MATCH (p_prop1_prop1)-[p_prop1_prop1_toDeletedResource:Reference]->(p_prop1_prop1_deletedResource:Page)-[p_prop1_prop1_fromDeletedResource:ReferencedBy]->(p_prop1_prop1)\n" +
                    "WHERE NOT p_prop1_prop1_deletedResource IN []\n" +
                    "DELETE p_prop1_prop1_toDeletedResource, p_prop1_prop1_fromDeletedResource\n" +
                    ...
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1\n" +
                    "OPTIONAL MATCH (p_prop1)-[p_prop1_toDeletedProperty:Property]->(p_prop1_deletedProperty:Content)-[p_prop1_fromDeletedProperty:Parent]->(p_prop1)\n" +
                    "WHERE NOT p_prop1_deletedProperty IN [p_prop1_prop0,p_prop1_prop1]\n" +
                    "DELETE p_prop1_toDeletedProperty, p_prop1_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1\n" +
                    "OPTIONAL MATCH (p_prop1)-[p_prop1_toDeletedResource:Reference]->(p_prop1_deletedResource:Page)-[p_prop1_fromDeletedResource:ReferencedBy]->(p_prop1)\n" +
                    "WHERE NOT p_prop1_deletedResource IN [p_prop1_ref0_p,p_prop1_ref1_p]\n" +
                    "DELETE p_prop1_toDeletedResource, p_prop1_fromDeletedResource\n" +



                    "MERGE (p_prop2_item0:Content {type: $p_prop2_item0.type,content: $p_prop2_item0.content})\n" +
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1,p_prop2_item0\n" +
                    "OPTIONAL MATCH (p_prop2_item0)-[p_prop2_item0_toDeletedProperty:Property]->(p_prop2_item0_deletedProperty:Content)-[p_prop2_item0_fromDeletedProperty:Parent]->(p_prop2_item0)\n" +
                    "WHERE NOT p_prop2_item0_deletedProperty IN []\n" +
                    "DELETE p_prop2_item0_toDeletedProperty, p_prop2_item0_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1,p_prop2_item0\n" +
                    "OPTIONAL MATCH (p_prop2_item0)-[p_prop2_item0_toDeletedResource:Reference]->(p_prop2_item0_deletedResource:Page)-[p_prop2_item0_fromDeletedResource:ReferencedBy]->(p_prop2_item0)\n" +
                    "WHERE NOT p_prop2_item0_deletedResource IN []\n" +
                    "DELETE p_prop2_item0_toDeletedResource, p_prop2_item0_fromDeletedResource\n" +


                    "MERGE (p_prop2_item1:Content {type: $p_prop2_item1.type,content: $p_prop2_item1.content})\n" +
                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1,p_prop2_item0,p_prop2_item1\n" +
                    "OPTIONAL MATCH (p_prop2_item1)-[p_prop2_item1_toDeletedProperty:Property]->(p_prop2_item1_deletedProperty:Content)-[p_prop2_item1_fromDeletedProperty:Parent]->(p_prop2_item1)\n" +
                    "WHERE NOT p_prop2_item1_deletedProperty IN []\n" +
                    "DELETE p_prop2_item1_toDeletedProperty, p_prop2_item1_fromDeletedProperty\n" +

                    "WITH s,p,p_ref0_p,p_ref1_p,p_ref2_p,p_ref0,p_ref1,p_ref2,p_prop0_ref0_p,p_prop0_ref1_p,p_prop0_ref0,p_prop0_ref1,p_prop0,p_prop1_prop0,p_prop1_prop1,p_prop1_ref0_p,p_prop1_ref1_p,p_prop1_ref0,p_prop1_ref1,p_prop1,p_prop2_item0,p_prop2_item1\n" +
                    "OPTIONAL MATCH (p_prop2_item1)-[p_prop2_item1_toDeletedResource:Reference]->(p_prop2_item1_deletedResource:Page)-[p_prop2_item1_fromDeletedResource:ReferencedBy]->(p_prop2_item1)\n" +
                    "WHERE NOT p_prop2_item1_deletedResource IN []\n" +
                    "DELETE p_prop2_item1_toDeletedResource, p_prop2_item1_fromDeletedResource\n" +
                    ...
                    "WITH p\n" +
                    "OPTIONAL MATCH (i:Site) WHERE NOT (i)-[:Owns]->()\n" +
                    "DETACH DELETE i"
                    ),
                "parameters": {
                    "s": {"name": "MySite"},
