...
const dbResult = {
    "results": [
        ...
        {
            "columns": ["{parent: property.checksum,references: collect({name: reference.name,type: reference.type,destination: resource.url,selector: {type: reference.selectorType,startSelector: {type: reference.startSelectorType, value: reference.startSelectorValue, offset: reference.startSelectorOffset},endSelector: {type: reference.endSelectorType, value: reference.endSelectorValue, offset: reference.endSelectorValue}}})}"],
            "data": [
                {
                    "row": [
                        {
                            ...
                            "references": [
                                {
                                    ...
                                    "selector": {
                                        ...
                                        "endSelector": {
                                            ...
                                            "offset": "//table[311]/tr[311]/td[3111]"
                                        }
                                    }
                                },
                                {
                                    ...
                                    "selector": {
                                        ...
                                        "endSelector": {
                                            ...
                                            "offset": "//table[312]/tr[312]/td[3122]"
                                        }
                                    }
                                }
                            ]
        ...
        {
            "columns": ["collect({name: relationship.name, checksum: property.checksum})"],
            "data": [
                {
                    "row": [
                        [
        ...
        {
            "columns": [
                "collect({type: subProperty.type,checksum: subProperty.checksum,name: subPropertyRelationship.name,content: subPropertyContent.value,isCollection: subPropertyRelationship.isCollection,selector: {type: subPropertyRelationship.selectorType,startSelector: {type: subPropertyRelationship.startSelectorType, value: subPropertyRelationship.startSelectorValue, offset: subPropertyRelationship.startSelectorOffset},endSelector: {type: subPropertyRelationship.endSelectorType, value: subPropertyRelationship.endSelectorValue, offset: subPropertyRelationship.endSelectorValue}}}) + pageProperties"
            ],
            "data": [
                {
                    "row": [
        ...
        {
            "columns": ["{property: property.checksum, subProperties: collect({name:subPropertyRelationship.name, checksum: subProperty.checksum})}"],
            "data": [
                {
                    "row": [
                        {
